function calCeLiuFlow(input_dir, video_name, video_type, type, output_path, output_mag_dir, output_flo_dir, output_mag_png_dir, output_flo_png_dir, output_brox_png_dir)
...
for i=1:n-1
    ...
    switch type
        case 'forward'
            [flo, mag] = CeLiuFlow(Img1, Img2);
        case 'backward'
            [flo, mag] = CeLiuFlow(Img2, Img1);
        otherwise
            [flo, mag] = CeLiuFlow(Img1, Img2);
    end    
