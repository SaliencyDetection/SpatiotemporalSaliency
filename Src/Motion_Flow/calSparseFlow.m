function calSparseFlow(input_dir, video_name, video_type, type, output_path, output_mag_dir, output_flo_dir, output_mag_png_dir, output_flo_png_dir, output_brox_png_dir)
...
for i=1:n-1
    ...
    switch type
        case 'forward'
            SparseFlow(path_img1, path_img2, path_flow);
        case 'backward'
            SparseFlow(path_img2, path_img1, path_flow);
        otherwise
            SparseFlow(path_img1, path_img2, path_flow);
    end
