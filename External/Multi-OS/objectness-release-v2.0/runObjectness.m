...
function boxes = runObjectness(img,dir_root,numberSamples,params)
...
%dir_root = [pwd '/objectness-release-v2.0/'];%change this to an absolute path
...
params.trainingImages = [dir_root '/Training/Images/'];
params.trainingExamples =  [dir_root '/Training/Images/Examples/'];
params.data =  [dir_root '/Data/'];
params.yourData =  [dir_root '/Data/yourData/'];
params.tempdir =  [dir_root '/tmpdir/'];
